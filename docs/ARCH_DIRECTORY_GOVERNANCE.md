...
Status: Active
Domain: ARCH
Canonical: `docs/ARCH_DIRECTORY_GOVERNANCE.md`
Related: `docs/README.md`, `docs/ADS版图自动仿真项目框架设计.md`, `docs/ARCH_DOCS_INTERNAL_STRUCTURE_PLAN.md`, `docs/ARCH_REFACTOR_TODO.md`, `docs/PYTHON_SCRIPT_MANAGEMENT.md`
...
迁移时必须生成路径映射表，并在旧路径放置迁移说明或在 README 中保留旧名索引，避免历史引用断裂。详细目录职责、当前文件目标归属、stub 格式和验收 gate 见 `ARCH_DOCS_INTERNAL_STRUCTURE_PLAN.md`。
