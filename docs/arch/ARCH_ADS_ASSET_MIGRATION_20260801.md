...
Status: Active
Domain: ARCH
Canonical: `docs/arch/ARCH_ADS_ASSET_MIGRATION_20260801.md`
Related: `docs/arch/ARCH_ADS_ASSET_MIGRATION_20260801.csv`, `docs/arch/ADS版图自动仿真项目框架设计.md`, `docs/arch/ARCH_REFACTOR_TODO.md`
...
完整条目见 `docs/arch/ARCH_ADS_ASSET_MIGRATION_20260801.csv`。
