...
Status: Draft
Domain: PY
Canonical: `docs/PYTHON_SCRIPT_MANAGEMENT.md`
Related: `docs/ADS版图自动仿真项目框架设计.md`, `docs/env/ENV_ADS_API_CAPABILITY_MATRIX.md`, `projects/bfp_6_8g_i7_fr4/docs/ADS自动仿真流程说明.md`
