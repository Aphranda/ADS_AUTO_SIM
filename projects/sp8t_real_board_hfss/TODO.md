...
- [x] Run `RF-PPA-SP10T-4F4H-ENIG-V1.0_Core1` as the chip-to-chip S2P case with the current 0402 0R resistor, then score it against the frozen baseline.
- [x] Add `RF-PPA-SP10T-4F4H-ENIG-V1.0_Core1` 0402 0R result to the report as an aligned comparison item next to the 0201 case.
